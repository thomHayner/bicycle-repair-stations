  ...
  return (
    <div
      ...
      className={[
        ...
        "bg-red-600 text-white text-sm font-medium px-4 py-3 rounded-xl shadow-lg",
    ...
    >
      ...
      <button
        ...
        className="ml-1 min-w-[32px] min-h-[32px] flex items-center justify-center rounded-full active:bg-red-500 transition-colors"
        aria-label="Dismiss"
      >
