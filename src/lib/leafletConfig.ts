...
export const userIcon = L.divIcon({
  ...
  html: `
    <div style="
      ...
      background: var(--color-secondary); border: 3px solid var(--color-surface);
    ...
    ">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="36" viewBox="0 0 28 36" style="position:absolute;top:0;left:0;">
        <path d="M14 0 C6.268 0 0 6.268 0 14 C0 24.5 14 36 14 36 C14 36 28 24.5 28 14 C28 6.268 21.732 0 14 0 Z"
          fill="var(--color-surface-container-high)" stroke="var(--color-surface)" stroke-width="2"/>
        <!-- Magnifying glass inside -->
        <circle cx="13" cy="13" r="4.5" stroke="var(--color-text-primary)" stroke-width="1.8" fill="none"/>
        <line x1="16.5" y1="16.5" x2="19.5" y2="19.5" stroke="var(--color-text-primary)" stroke-width="1.8" stroke-linecap="round"/>
      </svg>
    </div>
  `,
  iconSize: [28, 36],
...
export const stationIcon = L.divIcon({
  ...
  html: `
    <div style="
      ...
      background: var(--color-primary); border: 3px solid var(--color-border-search);
      box-shadow: 0 2px 6px rgba(0,0,0,0.3);
      display: flex; align-items: center; justify-content: center;
    ">
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--color-on-primary)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
