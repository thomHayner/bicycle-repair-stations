      ...
      >
        <div className="flex items-center px-3 gap-2" style={{ height: 56 }}>
          ...
          <button
            ...
            title="Open menu"
            className="w-9 h-9 flex items-center justify-center rounded-full text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 active:bg-slate-200 dark:active:bg-slate-700 transition-colors focus-visible:outline-2 focus-visible:outline-green-600 focus-visible:outline-offset-2 dark:focus-visible:outline-green-400 shrink-0"
          >
            ...
            <div className={[
              ...
              {isGeocoding ? (
                ...
                <button
                  ...
                  className="min-w-[44px] min-h-[44px] flex items-center justify-center text-[var(--color-primary)] hover:brightness-90 active:brightness-75 transition-colors focus-visible:outline-2 focus-visible:outline-green-600 focus-visible:outline-offset-2 dark:focus-visible:outline-green-400 shrink-0"
                >
          ...
          {LAYERS.map((l) => (
            <button
              ...
              className={[
                ...
                "focus-visible:outline-2 focus-visible:outline-green-600 focus-visible:outline-inset dark:focus-visible:outline-green-400",
              ].join(" ")}
            >
