  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="ml-1 min-w-[32px] min-h-[32px] flex items-center justify-center rounded-full hover:bg-black/10 active:bg-black/20 focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2 transition-colors"
        aria-label="Dismiss"
        title="Dismiss"
      >
